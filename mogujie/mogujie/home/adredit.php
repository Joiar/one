...
$id = $_GET['id'];
// 准备sql语句
$sql = "select * from ".FIX."address where id=$id";
// 发送sql请求
...
<body class="media_screen_1200">
    <div id="body_wrap">
    <!-- 页面内容 -->
        <form action="action/adraction.php?a=adredit&id=<?=$id?>" method='post'"> 
            ...
            <div id="J_otherAddrWrap">
                <div class="__addressPop">
                    <dl class="address_pop">
                        ...
                        <dd>
                            <i class="needicon">*</i>
                            <input type="text" data-type="c" value="<?= $row['code']?>" class="text formsize_normal J_postcode J_form vm" name="code" required>
                            <span class="prompt"></span>
                        </dd>
                        <dt>街道地址：</dt>
                        <dd>
                            <i class="needicon">*</i>
                            <textarea data-type="*" data-min="5" data-max="100" class="textarea formsize_large J_street J_form" name="address" cols="30" rows="3" required><?= $row['address']?></textarea>
                            <span class="prompt breakline">请填写街道地址，最少5个字，最多不能超过100个字</span>
                        </dd>
                        <dt>收货人姓名：</dt>
                        <dd><i class="needicon">*</i>
                            <input required type="text" data-type="*" value="<?= $row['name']?>" data-normal="" requiredclass="text formsize_normal J_name J_form vm" name="name" >
                            <span class="prompt"></span>
                        </dd>
                        <dt>手机：</dt>
                        <dd>
                            <i class="needicon">*</i>
                            <input type="text" required data-type="phone" value=" <?= $row['phone']?>"  data-normal="" class="text formsize_normal J_mobile J_form vm" name="phone">
                            <span class="prompt"></span>
                        </dd>
                        <dt></dt>
